...
ARG UID=1000
ARG GID=1000
RUN dpkg --add-architecture i386 && apt-get update && apt-get -y install sudo curl parallel libc6-i386 lib32stdc++6 lib32gcc1 lib32ncurses6 lib32z1 libsdl2-2.0 libsdl2-2.0:i386 libc6:i386 libncurses6:i386 libstdc++6:i386
