...
ARG UID=1000
ARG GID=1000
RUN dpkg --add-architecture i386 && apt-get update && env DEBIAN_FRONTEND="noninteractive" TZ="America/Phoenix" apt-get -y install sudo curl parallel rsync ssh libc6-i386 lib32stdc++6 lib32gcc1 lib32ncurses6 lib32z1 libsdl2-2.0 libsdl2-2.0:i386 libc6:i386 libncurses6:i386 libstdc++6:i386 libbz2-dev libbz2-dev:i386 libpython3.8 libpcap0.8 libpcap0.8:i386 libxcb-shm0 libxcb-shm0:i386 libasound2 libasound2:i386 libsdl2-2.0-0 libsdl2-2.0-0:i386 libsndio7.0 libsndio7.0:i386 libxv1 libxv1:i386
