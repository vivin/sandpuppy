...
plt.ylabel("Unique command sequences found", size=16)
plt.yscale('symlog')
#plt.title('Unique command-sequences with parameter size found over time', size=16)
plt.legend(fontsize=12)
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)

fig.tight_layout()
plt.subplots_adjust(top=1, bottom=0.07, left=0.08)
