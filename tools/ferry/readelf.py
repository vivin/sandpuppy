...
l = logging.getLogger('readelf')

file_name = 'elf_mips'
file_handler = logging.FileHandler(
    'readelf' + '_' + file_name + '_' + str(time.strftime('%Y%m%d%H%M%S')) + '.log')
...
init_state.memory.store(arg1, "-a".ljust(0x1000, "\x00"))
init_state.memory.store(arg2, ("/home/vivin/Projects/phd/tools/ferry/inputs/"+file_name).ljust(0x1000, "\x00"))
