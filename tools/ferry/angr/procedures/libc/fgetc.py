...
class fgetc(angr.SimProcedure):
    ...
    def run(self, stream, simfd=None, symbolic_wrap=False, switch_offset=-1):
        ...
        data, real_length, = simfd.read_data(1, symbolic_wrap=symbolic_wrap, switch_offset=switch_offset)
